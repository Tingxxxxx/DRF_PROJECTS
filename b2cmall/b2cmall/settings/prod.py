...
DATABASES = {
    'default': {  # 主機: 增刪改
        ...
        'HOST': os.getenv('DB_HOST', '127.0.0.1'),  # 172.29.164.7
        'PORT': int(os.getenv('DB_PORT')),          # 3306
        'USER': os.getenv('DB_USER', ''),           # DB_USER
        'PASSWORD': os.getenv('DB_PASSWORD', ''),   # 00000000
        'NAME': os.getenv('DB_NAME', ''),           # drf_mall
        'OPTIONS':{
    ...
    'slave': {  # 從機查詢
    'ENGINE': 'django.db.backends.mysql',  
    'HOST': os.getenv('SLAVE_DB_HOST', '127.0.0.1'),  # mysql-slave
    'PORT': int(os.getenv('SLAVE_DB_PORT')),          # 3306
    'USER': os.getenv('SLAVE_APP_USER'),              # slave_app_user
    'PASSWORD': os.getenv('SLAVE_APP_PASSWORD'),      # 00000000
    'NAME': os.getenv('DB_NAME', ''),                 # drf_mall
    },
}
...
# 配置快取
CACHES = {
    # 本地開發時使用 127.0.0.1:6379/0
    # docker容器化後使用 redis:6379/0，即容器名來在不同容器間連線
    'default': {

        'BACKEND': 'django_redis.cache.RedisCache',
        
        'LOCATION': f'redis://{REDIS_HOST}:{REDIS_PORT}/0',  # redis://redis:6379/0
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR.parent / "static" # 收集django靜態檔案的資料夾
...
ECPAY = {
    ...
    'CLIENT_BACK_URL': 'http://www.meiduo.site/pay_success.html?token={merchant_trade_no}',  # 用戶付款完返回頁面（前端)

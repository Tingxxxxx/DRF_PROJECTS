...
from .views import ECPayPaymentRequestView, ECPayPaymentRedirectView,ECPayPaymentNotifyView, ECPaymentStatusView
...
urlpatterns = [
    ...
    path('ecpay/status/<str:merchant_trade_no>', ECPaymentStatusView.as_view(), name='ecpay_status'),
